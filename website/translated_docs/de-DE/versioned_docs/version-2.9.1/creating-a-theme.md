...
title:
  How To: Create a theme for the Meteor UI
original_id: creating-a-theme
---

> ⚠️ Note: This guide has been deprecated as the release of Demand.0. The latest customization guide can be found [here](https://docs.reactioncommerce.com/docs/swag-shop-3).
