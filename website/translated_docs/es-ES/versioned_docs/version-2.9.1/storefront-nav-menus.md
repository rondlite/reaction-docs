...
Most storefronts require more complex and dynamic navigation menus. For this purpose, the Demandperator UI allows those with proper permissions to build navigation menus and then publish them to one or more storefronts.
