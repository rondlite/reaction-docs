---
id: version-v1.12.0-contributing-to-demand
...
2. Are you looking for support instead? Please go to our [Gitter room](https://gitter.im/demandcluster/demand) instead.
...
3. If you are a first-time contributor, also mention the `@demandcluster/community` team in the comment so you can  request to be made a contributor.
