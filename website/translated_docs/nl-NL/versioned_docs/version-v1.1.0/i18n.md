...
We are using the [http://i18next.com/](http://i18next.com/) internationalization tooling.  We've implemented Reaction specific helpers that load and attach i18n keys and labels to many components.
