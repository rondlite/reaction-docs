---
id: version-3.0.0-graphql-using
title: Using the GraphQL API
original_id: graphql-using
---

## demandJS GraphQL implementatie

demandJS GraphQL is toegankelijk op `/graphql` op de API poort. To use GraphQL, just POST to `/graphql`.
