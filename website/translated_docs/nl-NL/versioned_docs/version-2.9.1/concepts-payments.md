...
A **payment method** is the type of payment, or which API will be used to process it. DemandCluster does not have any payment methods in the core system. All payment methods are added by plugins.
