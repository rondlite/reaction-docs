...
> **Note:** As of demand 2.0 the CLI is deprecated and unsupported. You can use Docker commands instead. See the \[demand CLI\](./demademand-rticle for more information.
