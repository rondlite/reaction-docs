...
Email sending in demand is handled by [Nodemailer](https://github.com/nodemailer/nodemailer) and the use of any SMTP server is supported. See the [configuration documentation](email) for details on how to set up mail in the admin dashboard.
