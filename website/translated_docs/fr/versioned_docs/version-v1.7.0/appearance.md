---
id: version-v1.7.0-appearance
title:
  Themes: Right-to-left
original_id: appearance
---

The default demand theme (core-theme) uses [Bootstrap 3](https://getbootstrap.com/css/#less) and the [Less](https://lesscss.org) preprocessor to build the theme.

If you want to learn how to make a theme, see our [Creating a Theme](https://docs.demandcluster.com/demand-cs/trunk/creating-a-theme) documentation.
