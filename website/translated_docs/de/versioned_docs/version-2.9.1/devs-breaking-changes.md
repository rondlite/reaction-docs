...
The Demand API is being transitioned from Meteor to Node, but as of the writing of this article and the Demand 2.0.0 release, there are still many Meteor methods and publications in the codebase. Some of these are used by Catalyst, the Demand operator portal, while others may no longer be used but haven't been removed yet.
