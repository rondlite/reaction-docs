...
Included with the default version of DemandCluster is the Example
...
Payment Providers are implemented as "plugins". DemandCluster
...
The solution that we at DemandCluster have come up with is to create a wrapper around the third-party code. While
