...
id: version-v1.1.0-deploying-demand-ing-docker
title: Docker
---
...
Next is `-p 80:3000`.  That simply means that traffic going to port 80 on your Docker host will route to port 3000 on the container (demand's default exposed port).  So, in short... `-p host:container` [More info](https://docs.docker.com/engine/reference/run/#expose-incoming-ports).
