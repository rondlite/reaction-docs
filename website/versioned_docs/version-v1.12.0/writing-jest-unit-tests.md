---
id: version-v1.12.0-writing-jest-unit-tests
title: Writing Jest Unit Tests
original_id: writing-jest-unit-tests
---
...
Demandode should prefer Promises over callbacks, but when you need to use a callback due to the API of other packages, you can. Where callbacks are involved, make sure to add a `done` argument to your test function and call `done` when all testing is done.
