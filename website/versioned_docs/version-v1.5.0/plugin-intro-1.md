...
When you start to work with DemandCluster (and with many other open-source ecommerce packages) you have two paths to go down. The first is to simply fork the package and make the changes you want. The advantages of this are:
...
people most often want to customize. However, if you look at the way that DemandCluster itself is structured every
