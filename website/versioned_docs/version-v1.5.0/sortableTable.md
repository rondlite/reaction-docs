...
SortableTable is available as via `registerComponent`. See the [Demand Components API Docs](https://docs.reactioncommerce.com/reaction-docs/trunk/components-api) for more info.
