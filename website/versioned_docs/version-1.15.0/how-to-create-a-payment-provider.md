...
Included with the default version of Demands the Example
...
The solution that we at Demandave come up with is to create a wrapper around the third-party code. While
