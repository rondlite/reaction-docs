...
> ⚠️ Note: This guide has been deprecated as the release of Demand.0. The latest custom home page guide can be found [here](https://docs.reactioncommerce.com/docs/swag-shop-3).
