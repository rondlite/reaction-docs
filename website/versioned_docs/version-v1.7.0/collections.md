...
Some of the [Demandollections](https://github.com/reactioncommerce/reaction/blob/v1.7.0/lib/collections/collections.js) are:
...
The [Demandollection hooks](https://github.com/reactioncommerce/reaction/blob/v1.7.0/packages/reaction-collections/common/collections/hooks/hooks.js) extend [Mongo.Collection](http://docs.meteor.com/#/full/mongo_collection) with before/after hooks for `insert`, `update`, `remove`, `find`, and `findOne`.
