---
id: version-v1.7.0-code-of-conduct
...
This code of conduct applies to all spaces managed by Demand Cluster. This includes our [development chat room], Reaction events and meetups, and any other forums or service created by the core project team which the community uses for communication. In addition, violations of this code outside these spaces may affect a person's ability to participate within them.

If you believe someone is violating the code of conduct, we ask that you report it by emailing <mailto:conduct@demandcluster.com>. For more details, please see our [Reporting Guidelines](reporting-guide.md).
