...
SortableTable is available as via `registerComponent`. See the [Reaction Components API Docs](https://docs.demandcluster.com/reaction-docs/trunk/components-api) for more info.
