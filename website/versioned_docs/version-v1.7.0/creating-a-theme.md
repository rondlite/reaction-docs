...
> ⚠️ Note: This guide has been deprecated as the release of Reaction 2.0. The latest customization guide can be found [here](https://docs.demandcluster.com/docs/swag-shop-3).
...
Ok, let's dive into it: Get the [Reaction Example Theme].
