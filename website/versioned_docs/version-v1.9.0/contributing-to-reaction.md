---
id: version-v1.9.0-contributing-to-reaction
...
The Demandeam reviewer is responsible for merging the PRs they approved, unless the PR submitter has requested otherwise.
