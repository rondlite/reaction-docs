...
You can also use Docker Compose to run Demandnd Mongo in separate connected Docker containers.
...
If you have a custom Docker image of your Demandpp, you can modify the `docker-compose-demo.yml` file to point to use it by changing the `image` name of the `reaction` service.
