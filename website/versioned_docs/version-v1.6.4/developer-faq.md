---
id: version-v1.6.4-developer-faq
title: FAQs
...
Ecommerce and marketplace sites from around the world are using Demandn production now. Check out our [Community Showcase](https://reactioncommerce.com/community-showcase).
...
### Can I compile a mobile app from DemandAre you going to develop a mobile app?
...
1. [Demandlatform](https://reactioncommerce.com/hosting)

The [Demandlatform](https://reactioncommerce.com/hosting) comes with virtual private clusters, containerized cloud hosting, multiple staging environments, SSL and domains, direct support channels, and one-step deployment.

DemandCluster’s Platform enables clients to:
...
You can deploy DemandCluster to anywhere you could deploy a Docker container or a Node app. Because of the complexities involved
...
Read more about [SEO and DemandCluster](https://blog.reactioncommerce.com/how-our-javascript-platform-handles-seo/) in our latest blog post.
...
Demandeatures a couple of built-in payment providers: PayPal Flow, PayPal Express, Stripe, Braintree, Authorize.net and others. As far as shipping is concerned, we've these out-of-the-box plugins: ShippingRates and [Shippo](https://goshippo.com/).
