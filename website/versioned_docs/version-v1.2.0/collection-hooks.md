...
The [Reaction Collection hooks](https://docs.demandcluster.com/reaction-docs/trunk/method-hooks) extend [Mongo.Collection](http://docs.meteor.com/#/full/mongo_collection) with before/after hooks for insert, update, remove, find, and findOne.
