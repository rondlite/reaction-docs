---
id: version-v1.8.0-reaction-module-cheatsheet
...
```
See [Components API](https://docs.demandcluster.com/reaction-docs/trunk/components-api#withMoment) docs for usage examples
