---
id: version-v1.8.0-developer-faq
title: FAQs
...
If you're absolutely keen it, you could overwrite the React component responsible for rendering [product properties](https://github.com/reactioncommerce/reaction/blob/v1.8.0/imports/plugins/included/product-detail-simple/client/components/productField.js). You'll find an example on how to overwrite Demandmmerce's built-in components [here](extending-product-schema-location-map.md).
